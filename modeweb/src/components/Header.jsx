...
const Header = ({ onToggleSidebar, currentPage }) => {
  ...
  return (
    <header className="bg-gray-100 shadow-sm border-b border-gray-200 z-10">
      <div className="flex items-center justify-between h-16 px-4 md:px-6">
        <div className="flex items-center space-x-4">
          ...
          >
            <HiMenu className="text-xl text-gray-200" />
          </button>
        ...
        <div className="flex items-center space-x-3">
          <div className="relative" ref={profileRef}>
            <button
              ...
              className="flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-100/10 transition-colors"
            >
              ...
              <HiChevronDown className="text-gray-200 hidden md:block" />
            </button>
            {isProfileOpen && (
