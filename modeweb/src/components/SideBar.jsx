...
const SideBar = ({ isOpen, isMobile, onToggle }) => {
  ...
  const sideBarData = [
    ...
    },
    {
      ...
      subBar: [{ id: 31, label: "User Lists", path: "/users" }],
    },
    {
      id: 4,
      label: "Customer",
      ...
      subBar: [
        ...
        { id: 42, label: "Add Customer", path: "/add-customer" },
      ],
    },
    {
      id: 5,
      ...
      subBar: [{ id: 51, label: "Profile Setup", path: "/profiles" }],
    },
    {
      id: 6,
      label: "Glass",
      ...
      subBar: [{ id: 61, label: "Glass Setup", path: "/glasss" }],
    },
    {
      id: 7,
      label: "Mosquito",
      ...
      subBar: [
        { id: 71, label: "Mosquito Setup", path: "/mosquito-net" },
      ],
    },
    {
      id: 8,
      ...
      subBar: [{ id: 81, label: "Vat Setup", path: "/vat-setup" }],
    },
    {
      id: 9,
      label: "All Customer",
      role: ["admin"],
      icon: <HiUserGroup className="text-xl" />,
      subBar: [{ id: 91, label: "All Customer", path: "/all-customer" }],
    },
    {
      id: 10,
      label: "Quotation",
      ...
      icon: <HiCalculator className="text-xl" />,
      subBar: [
        { id: 101, label: "Quotation", path: "/quotation" },
        {
          id: 102,
    ...
    },
    {
      ...
      subBar: [{ id: 111, label: "Mail Data", path: "/mail-data" }],
    },
    {
      id: 12,
      label: "Phone Data",
      ...
      subBar: [{ id: 121, label: "Phone Data", path: "/phone-data" }],
    },
  ];
  ...
  const renderTooltip = (label) =>
    ReactDOM.createPortal(
      <div
        className="fixed px-3 py-2 bg-yellow-700 text-white text-sm rounded-lg shadow-lg z-9999 whitespace-nowrap transition-all duration-150"
        style={{
          top: tooltipPos.y,
          left: tooltipPos.x,
  ...
  return (
    <div className="h-full bg-linear-to-b from-yellow-900 via-gray-700 to-red-900 text-white flex flex-col">
              ...
              <div
                className={`group relative flex items-center justify-between p-3 rounded-lg cursor-pointer transition-all duration-200 ${
                  isItemActive(item)
                    ...
                    : "hover:bg-yellow-800 text-gray-300"
                }`}
                onClick={() => {
      ...
      {isOpen && (
        <div className="p-4 border-t border-gray-800 text-center text-gray-200 text-sm">
          v1.0.0
        </div>
      )}
    </div>
